...
namespace ZNRS.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //public OauthController(IOptions<AppAuthenticationSettings> appSettings, ZNRSDbContext dbContext)
            //{
            ...
            services.AddDbContext<ZNRSDbContext>(options =>
            //options.UseSqlServer(Configuration.GetConnectionString("MssqlConnection"),b=>b.UseRowNumberForPaging())
                {
                    if (ToolService.DbType.Equals("mysql"))
                    {
                        ...
                        DBHelper.dbcon = Configuration.GetConnectionString("MysqlConnection");
                    }
                    else
                    {
                        options.UseSqlServer(Configuration.GetConnectionString("MssqlConnection"), b => b.UseRowNumberForPaging());
                        DBHelper.dbcon = Configuration.GetConnectionString("MssqlConnection");
                    }
