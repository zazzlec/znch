...
using ZNRS.Api.RequestPayload.Rbac.Chqpoint;
using ZNRS.Api.ViewModels.Rbac.Dncchqpoint;
...
namespace ZNRS.Api.Controllers.Api.ZNRS1
{
    ...
    public class DncchqpointController : ControllerBase
    {
        ...
        public DncchqpointController(ZNRSDbContext dbContext, IMapper mapper)
        {
