...
using ZNRS.Api.RequestPayload.Rbac.Ch_parameter;
using ZNRS.Api.ViewModels.Rbac.Dncch_parameter;
...
namespace ZNRS.Api.Controllers.Api.ZNRS1
{
    ...
    public class Dncch_parameterController : ControllerBase
    {
        ...
        public Dncch_parameterController(ZNRSDbContext dbContext, IMapper mapper)
        {
