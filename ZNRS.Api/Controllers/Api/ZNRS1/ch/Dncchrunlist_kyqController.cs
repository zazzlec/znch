...
using ZNRS.Api.RequestPayload.Rbac.Chrunlist_kyq;
using ZNRS.Api.ViewModels.Rbac.Dncchrunlist_kyq;
...
namespace ZNRS.Api.Controllers.Api.ZNRS1
{
    ...
    public class Dncchrunlist_kyqController : ControllerBase
    {
        ...
        public Dncchrunlist_kyqController(ZNRSDbContext dbContext, IMapper mapper)
        {
