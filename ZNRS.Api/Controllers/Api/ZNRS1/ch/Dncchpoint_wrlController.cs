...
using ZNRS.Api.RequestPayload.Rbac.Chpoint_wrl;
using ZNRS.Api.ViewModels.Rbac.Dncchpoint_wrl;
...
namespace ZNRS.Api.Controllers.Api.ZNRS1
{
    ...
    public class Dncchpoint_wrlController : ControllerBase
    {
        ...
        public Dncchpoint_wrlController(ZNRSDbContext dbContext, IMapper mapper)
        {
