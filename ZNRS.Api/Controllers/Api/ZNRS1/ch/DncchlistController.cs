...
using ZNRS.Api.RequestPayload.Rbac.Chlist;
using ZNRS.Api.ViewModels.Rbac.Dncchlist;
...
namespace ZNRS.Api.Controllers.Api.ZNRS1
{
    ...
    public class DncchlistController : ControllerBase
    {
        ...
        public DncchlistController(ZNRSDbContext dbContext, IMapper mapper)
        {
        ...
        {
            var response = ResponseModelFactory.CreateInstance;
            //ZNRS.Api.dataoperate.Chcompute.Znchrun(bid, DateTime.Now, type);
