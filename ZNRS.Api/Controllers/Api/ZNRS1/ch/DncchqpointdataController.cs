...
using ZNRS.Api.RequestPayload.Rbac.Chqpointdata;
using ZNRS.Api.ViewModels.Rbac.Dncchqpointdata;
...
namespace ZNRS.Api.Controllers.Api.ZNRS1
{
    ...
    public class DncchqpointdataController : ControllerBase
    {
        ...
        public DncchqpointdataController(ZNRSDbContext dbContext, IMapper mapper)
        {
