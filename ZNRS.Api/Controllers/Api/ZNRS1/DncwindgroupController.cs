...
using ZNRS.Api.RequestPayload.Rbac.Windgroup;
using ZNRS.Api.ViewModels.Rbac.Dncwindgroup;
...
namespace ZNRS.Api.Controllers.Api.ZNRS1
{
    ...
    public class DncwindgroupController : ControllerBase
    {
        ...
        public DncwindgroupController(ZNRSDbContext dbContext, IMapper mapper)
        {
