...
namespace ZNRS.Api.ViewModels.Rbac.Dncchpoint_wrl
{
	public class Dncchpoint_wrlJsonModel
	{
    	...
    	/// 吹灰器ID
    	/// </summary>
    	public ZNRS.Api.Entities.Dncchqpoint DncChqpoint { get; set; } 
    	...
    	/// 吹灰区域ID
    	/// </summary>
    	public ZNRS.Api.Entities.Dnccharea DncCharea { get; set; } 
