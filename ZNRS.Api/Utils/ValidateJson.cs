                ...
                for (int i = 0; i < data.Count; i++)
                {
                    ...
                    for (int j = 0; j < item.Count; j++)
                    {
                        ...
                        if (targetPP != null)
                        {
                            ...
                            else if (targetPP.PropertyType.FullName == typeof(System.Single).FullName)
                            {
                                targetPP.SetValue(t, float.Parse(item[j].ToString().Replace("\"", "")), null);
                            }
