...
namespace SynZNCH
{
    public class DBHelper
    {
        ...
        //用户名：sbwl_ZNCH
        //密码：105*sbwlZNCH*
        //"Data Source=sqlpaas1400; Initial Catalog=SBWLZNCH;User Id=sbwl_ZNCH; PassWord=105*sbwlZNCH*;"


        //private string m_dbs = "Data Source=127.0.0.1;Database=sg_ZNCH;User ID=root;Password=123456;pooling=true;CharSet=utf8;port=3306;sslmode=none";
       // private string m_dbs = "Data Source=DESKTOP-SF05DK1; Initial Catalog=SBWLZNCH;User Id=sa; PassWord=123;";
        /// <summary>
        /// 构造函数
        /// </summary>
        public DBHelper() { }
