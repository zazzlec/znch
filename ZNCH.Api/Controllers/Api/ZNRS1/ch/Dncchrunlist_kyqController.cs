...
using ZNCH.Api.RequestPayload.Rbac.Chrunlist_kyq;
using ZNCH.Api.ViewModels.Rbac.Dncchrunlist_kyq;
...
namespace ZNCH.Api.Controllers.Api.ZNCH1
{
    ...
    public class Dncchrunlist_kyqController : ControllerBase
    {
        ...
        public Dncchrunlist_kyqController(ZNCHDbContext dbContext, IMapper mapper)
        {
