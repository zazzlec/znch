...
using ZNCH.Api.RequestPayload.Rbac.Chlist;
using ZNCH.Api.ViewModels.Rbac.Dncchlist;
...
namespace ZNCH.Api.Controllers.Api.ZNCH1
{
    ...
    public class DncchlistController : ControllerBase
    {
        ...
        public DncchlistController(ZNCHDbContext dbContext, IMapper mapper)
        {
        ...
        {
            var response = ResponseModelFactory.CreateInstance;
            //ZNCH.Api.dataoperate.Chcompute.Znchrun(bid, DateTime.Now, type);
