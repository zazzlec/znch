...
using ZNCH.Api.RequestPayload.Rbac.Chqpointdata;
using ZNCH.Api.ViewModels.Rbac.Dncchqpointdata;
...
namespace ZNCH.Api.Controllers.Api.ZNCH1
{
    ...
    public class DncchqpointdataController : ControllerBase
    {
        ...
        public DncchqpointdataController(ZNCHDbContext dbContext, IMapper mapper)
        {
