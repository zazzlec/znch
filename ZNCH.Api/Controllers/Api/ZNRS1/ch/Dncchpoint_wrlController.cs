...
using ZNCH.Api.RequestPayload.Rbac.Chpoint_wrl;
using ZNCH.Api.ViewModels.Rbac.Dncchpoint_wrl;
...
namespace ZNCH.Api.Controllers.Api.ZNCH1
{
    ...
    public class Dncchpoint_wrlController : ControllerBase
    {
        ...
        public Dncchpoint_wrlController(ZNCHDbContext dbContext, IMapper mapper)
        {
