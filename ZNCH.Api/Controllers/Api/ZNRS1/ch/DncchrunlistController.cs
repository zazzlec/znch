...
using ZNCH.Api.RequestPayload.Rbac.Chrunlist;
using ZNCH.Api.ViewModels.Rbac.Dncchrunlist;
...
namespace ZNCH.Api.Controllers.Api.ZNCH1
{
    ...
    public class DncchrunlistController : ControllerBase
    {
        ...
        public DncchrunlistController(ZNCHDbContext dbContext, IMapper mapper)
        {
