...
using ZNCH.Api.RequestPayload.Rbac.Charea_his;
using ZNCH.Api.ViewModels.Rbac.Dnccharea_his;
...
namespace ZNCH.Api.Controllers.Api.ZNCH1
{
    ...
    public class Dnccharea_hisController : ControllerBase
    {
        ...
        public Dnccharea_hisController(ZNCHDbContext dbContext, IMapper mapper)
        {
