...
using ZNCH.Api.RequestPayload.Rbac.Chhzpoint;
using ZNCH.Api.ViewModels.Rbac.Dncchhzpoint;
using System.Transactions;
using System.Collections.Generic;
using ZNCH.Api.Utils;
using ZNCH.Api.dataoperate;
...
namespace ZNCH.Api.Controllers.Api.ZNCH1
{
    ...
    public class DncchhzpointController : ControllerBase
    {
        ...
        public DncchhzpointController(ZNCHDbContext dbContext, IMapper mapper)
        {
