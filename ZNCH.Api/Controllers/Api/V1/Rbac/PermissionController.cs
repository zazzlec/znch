...
using ZNCH.Api.Entities.QueryModels.DncPermission;
using ZNCH.Api.Extensions;
using ZNCH.Api.Extensions.AuthContext;
using ZNCH.Api.Models.Response;
using ZNCH.Api.RequestPayload.Rbac.Permission;
...
namespace ZNCH.Api.Controllers.Api.V1.Rbac
{
    ...
    public class PermissionController : Controller
    {
        ...
        public PermissionController(ZNCHDbContext dbContext, IMapper mapper)
        {
